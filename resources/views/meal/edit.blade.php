                    ...
                    <form action="{{route('meal.update',$meal->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body text-right">
                            <div class="form-group">
                                ...
                                <input id="name" type="text" class="form-control" value="{{ $meal->name }}" name="name"
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input id="price" type="number" value="{{ $meal->price }}" name="price"
                                           class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    ...
                                    <br>
                                    <div class="form-group">
                                        <img id="frame" src="{{asset($meal->image) }}"
                                             class="w-25" alt="">
                                    </div>
                                    <br>
